...
class Circle extends Shape {
  ...
  render() {
    ...
    width="300" height="200"
    xmlns="https://www.w3.org/2000/svg"><circle cx="150" cy="110" r="80" fill="${this.logoColor}"/><text x="150" y="100" font-size="60" text-anchor="middle" fill="${this.textColor}">${this.logoCharacters}</text></svg>`
...
class Square extends Shape {
  ...
  render() {
    ...
    width="300" height="200"
    xmlns="https://www.w3.org/2000/svg"><rect x="10" y="10" width="300" height="200" fill="${this.logoColor}"/><text x="150" y="100" font-size="60" text-anchor="middle" fill="${this.textColor}">${this.logoCharacters}</text></svg>`
