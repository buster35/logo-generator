...
class Circle extends Shape {
  ...
  render() {
    ...
    width="300" height="200"
    xmlns="https://www.w3.org/2000/svg"><circle cx="150" cy="120" r="80" fill="${this.logoColor}"/><text x="150" y="110" font-size="60" text-anchor="middle" fill="${this.textColor}">${this.logoCharacters}</text></svg>`
